...
@dask.delayed
def run_feature_extraction(filepath, dst_dir):
    with dask.config.set(scheduler="single-threaded"):
        try: 
            run_granule_feature_extraction(filepath, dst_dir=dst_dir)
...
if __name__ == "__main__": #  https://github.com/dask/distributed/issues/2520
    ...
    list_delayed = [run_feature_extraction(filepath, dst_dir=dst_dir) for filepath in filepaths]
